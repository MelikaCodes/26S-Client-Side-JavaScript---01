...
function setWeather() {
	...
	// console.warn("event listener works!");
	// console.error("event listener works!");
...
function setBackgroundColor(temperature){
			//change screen color base on temperture 
		if(temperature >=15){
...
switch(speed){
	// STEP 5b: Build out four cases, followed by a default
		...
		default: 
			windComment.textContent="No wind available";
	}
