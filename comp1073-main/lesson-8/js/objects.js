...
let person = {
    ...
    age: 16,
    gender: "male",
    interests: ["swiming", "writing", "coding"],
    greetings: function(){
        //Hey, this is Prinyansh Thaker!
        alert(`Hey, this is ${this.name.firstName} ${this.name.lastName}!`)
    },
    bio: function(){
        //the intrests of Priyansh Thaker, of age: 16, of gender: male, are-interests-.
