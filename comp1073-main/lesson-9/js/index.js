...
function Coffee(size, isDecaf, qtyCream, qtySuger) {
    this.size=size;
    this.isDecaf=isDecaf;
    this.qtyCream= qtyCream;
    this.qtySuger= qtySuger;
    this.decaf= this.isDecaf ? "decafinated" : "caffinated" ;
    this.description = function(){
        //small caffinated coffee with 1 cream and 2 sugar 
        return `A ${this.size} ${this.decaf} coffee with ${this.qtyCream} cream and ${this.qtySuger} sugar.`;
    };
};
/* STEP 2: Instatiate a coffee based on the above constructor function */
let melikaCoffee= new Coffee("medium", false, 2, 1);
output.textContent=melikaCoffee.description();
